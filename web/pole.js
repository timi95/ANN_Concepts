...
var ASM_CONSTS = {
 ...
 154130: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 154213: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 154282: () => { return window.innerWidth; },  
 154312: () => { return window.innerHeight; }
};
